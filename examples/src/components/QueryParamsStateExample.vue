<template>
  <section id="state-queryparams" class="section">
    <div>
      ...
      <p class="info">
        Try sorting or filtering - notice how the URL updates! You can share this URL or use browser back/forward.
      </p>
...
const queryParamsStateProvider = new QueryParamsStateProvider({ router, prefix: 'qp' })
const queryParamsProvider = new ArrayDataProvider({
  items: stateUsers,
  stateProvider: queryParamsStateProvider
})
</script>
